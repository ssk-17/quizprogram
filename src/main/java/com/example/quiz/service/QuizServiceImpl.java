...
import com.example.quiz.client.QuizClientImpl;
...
public class QuizServiceImpl implements QuizService{
    @Autowired
    private QuizClientImpl quizClientImpl;
    ...
    public QuizCategoryListResponse getQuizzes() {
        Mono<QuizResponse> quizResponse1 = quizClientImpl.getQuizzes(url1);
        Mono<QuizResponse> quizResponse2 = quizClientImpl.getQuizzes(url2);
